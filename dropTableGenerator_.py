...
"""
Functions identically to dropTableGenerator.py, but does not
include the ``INSERT INTO monsterdrops...`` boilerplate syntax
at the beginning or a semicolon at the end, so that multiple
outputs of this script can be concatenated.
"""
...
for tablestring in tablestrings:
    ...
    with o("String.wz/Consume.img.xml", "r", "utf-8") as usestringf:
        ...
        for usematch in usematches:
            usename = usematch.group(2).strip()
