    ...
    var load = function(c, o) {
        return (function() {
            ...
            var talk = function(selection) {
                ...
                if (nodeIndex.length === 0 && selection < 0) return exit();
                ...
                lastPrompt = node.prompt;
                var message = node.prompt + "\r\n\r\n";
                var choices = node.choices;
                for (i = 0; i < choices.length; ++i) {
                    var choice = choices[i];
                    if (choice[1].move !== undefined) {
                        message += "#L" + (choice[1].move > 0 ? i : choice[1].move - 1) + "#" + choice[0] + "#l\r\n";
                    } else {
